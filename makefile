install:
	gcc -O3 src/server/server.c src/handlers/writeMsgHandler.c src/handlers/readMsgHandler.c \
	...
	gcc -O3 src/client/client.c src/handlers/writeMsgHandler.c src/handlers/readMsgHandler.c \
